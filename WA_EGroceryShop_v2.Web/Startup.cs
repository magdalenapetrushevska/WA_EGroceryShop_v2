...
using WA_EGroceryShop_v2.Domain;
using WA_EGroceryShop_v2.Domain.Identity;
using WA_EGroceryShop_v2.Repository;
using WA_EGroceryShop_v2.Repository.Implementation;
using WA_EGroceryShop_v2.Repository.Interface;
using WA_EGroceryShop_v2.Services;
using WA_EGroceryShop_v2.Services.Implementation;
using WA_EGroceryShop_v2.Services.Interface;


namespace WA_EGroceryShop_v2.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IProductPromotionService, Services.Implementation.ProductPromotionService>();
            services.AddTransient<IProductCategoryPromotionService, ProductCategoryPromotionService>();
